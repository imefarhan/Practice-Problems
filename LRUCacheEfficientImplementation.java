...
public class LRUCacheEfficientImplementation {

	HashMap<Integer, Entry> hashmap;
	Entry start, end;
	int LRU_SIZE = 4; // Here i am setting 4 to test the LRU cache
	
	public LRUCacheEfficientImplementation() {
	...
	public void addAtTop(Entry node) {
		...
		//Will assign the first node as a last node.
		if (end == null)
			end = start;
	}
	...
	public void removeNode(Entry node) {
        ...
        //Simply conecting the Right pointer
		if (node.left != null) {
	...
	public static void main(String[] args) throws java.lang.Exception {
		// your code goes here
		LRUCacheEfficientImplementation lrucache = new LRUCacheEfficientImplementation();
